  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <p className="text-gray-500">Loading migration details...</p>
      </div>
    );
  }
  ...
  if (!data || !data.repositoryMigration) {
    return (
      <div className="bg-yellow-50 p-6 rounded-lg shadow-sm">
        <h2 className="text-lg font-semibold text-yellow-800 mb-2">Migration Not Found</h2>
        <p className="text-yellow-600">The requested migration could not be found.</p>
        <Link to="/" className="mt-4 inline-block text-primary-600 hover:text-primary-800">
          &larr; Back to Dashboard
        </Link>
      </div>
    ...
    <div>
      ...
      <div className="bg-white shadow overflow-hidden rounded-lg">
        <div className="px-4 py-5 sm:px-6 bg-gray-50">
          <h2 className="text-lg font-medium text-gray-900">Repository Migration Information</h2>
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">Enterprise</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
            ...
            {migration.migrationLogUrl && (
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">Migration log</dt>
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <a 
